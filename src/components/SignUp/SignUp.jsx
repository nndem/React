...
import {logInProcessStart, setUserType} from '../../store/session/actions';
...
export default function SignUp() {
  ...
  return (
    <>
      ...
      {userType !== null && userType === 'company' ? <SignUpForCompany /> : ''}
      {userType !== null && userType === 'developer' ? <SignUpForDev /> : ''}
    </>
  );
}
